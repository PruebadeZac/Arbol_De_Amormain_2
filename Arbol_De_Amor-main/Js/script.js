...
function showDedicationText() { //seguidores
  ...
  if (!text) {
    text = `Te Amo con todo mi corazon Cori<3:\n\ Desde que te conoci, eh sido la persona mas afortunada en este mundo, estoy feliz de ser tu novio, soy feliz de ser la persona que va estar a tu lado en la buenas y en la malas.\n \n Se que no todo sera facil, pero se que lograremos todo lo que nos propongamos.`;  } else {
...
function showSignature() {
  ...
  signature.textContent = firma ? decodeURIComponent(firma) : "Con Todo Mi Amor, Jeremy G.";
...
function showCountdown() {
  ...
  let startDate = startParam ? new Date(startParam + 'T00:00:00') : new Date('2025-03-14T00:00:00'); 
  let eventDate = eventParam ? new Date(eventParam + 'T00:00:00') : new Date('2026-03-14T00:00:00');
  ...
  function update() {
    ...
    container.innerHTML =
      `Dias siendo Novios: <b>${days}</b> días<br>` +
